...
prev_date=dt.datetime.now()-dt.timedelta(hours=6)
#print(now_date)
#print(prev_date)
...
def gethistory(symbol1,type,duration):
    ...
    while start <= end:
        ...
        data = {"symbol":symbol,"resolution":"5","date_format":"1","range_from":start,"range_to":end2,"cont_flag":"1"}
...
data=gethistory('NIFTYBANK','INDEX',0)
print(data)
